  ...
  list: [
      ...
      descriptions: [
        ...
        },
        {
          ...
          descriptions: [
            ...
            { content: '기존 사용자 잔존율 계산 로직을 리팩토링하여 용량은 줄이고, 쿼리 속도를 높임' },
          ],
        },
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '분석의 다양화를 위해 디멘젼과 세그먼트를 제공하여 실시간 분석 가능한 구조로 개선' },
            { content: 'Google Analytics, NHN Cloud 에서 제공하는 잔존율을 참고하여 잔존율 개념 재정의' },
    ...
    },
    {
      ...
      descriptions: [
        ...
        { content: '행정안전부에서 요구한 트래픽 제한에 맞춘 구조 개발을 위해 챗봇에 Rate Limit 적용' },
    ...
    },
    {
      ...
      where: '카카오 (Kakao)',
      descriptions: [
        { content: '처음으로 홀로 개발자로 참여해 다른 직군과의 협업을 이끈 경험. 개인적으로 유의미했던 과제' },
      ],
    },
    {
      ...
      descriptions: [
        ...
        { content: '2023년 챗봇 말풍선 정합성 개선',
          weight: 'MEDIUM',
          descriptions: [
            { content: '사용자가 응답으로 사용하는 API 말풍선과 플랫폼에서 지원하는 말풍선 프로토콜 통합 및 코드 개발' },
